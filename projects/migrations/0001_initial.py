    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(blank=True, choices=[(0, 'draft'), (1, 'pre-PMB'), (2, 'pipeline'), (3, 'portfolio'), (4, 'terminated')], default=0, null=True)),
                ...
                ('agreement_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dropdowns.Agreement')),
                ...
                ('delivery_terms', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dropdowns.DeliveryTerm')),
                ...
                ('product_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dropdowns.ProductCategory')),
                ('registration_strategy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dropdowns.RegistrationStrategy')),
